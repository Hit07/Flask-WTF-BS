...
from wtforms import StringField, PasswordField, \
    SubmitField  # it will be used to create the form fields in the form class below
from flask_wtf import FlaskForm
from wtforms.validators import DataRequired, Email, \
    Length  # it will be used to validate the form fields in the form class below
